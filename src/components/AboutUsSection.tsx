...
const AboutSection = () => {
    return (
        <section
            id="about"
            className="relative items-center justify-center mt-10 bg-gray-100 overflow-hidden"
        >
            ...
            <div className='flex flex-col mt-2 text-center p-1'>
                ...
                <p className="text-black mt-2 md:text-lg" style={{ fontFamily: 'Roboto, sans-serif' }}>
